Feature: Accessibility
  ...
  Scenario: Screenreader interpreting an image alt link in wysiwyg media
    ...
    Then I should see the link "Web Experience Toolkit Logo" in the "Content Well"
    And I am on "fr/contenu/wxt-drupal"
    Then I should see the link "Boîte à outils de expérience Web Logo" in the "Content Well"

 @api
  Scenario: Screenreader interpreting an image alt link in wysiwyg field
    Given I am on "en/content/drupal-platform"
    Then I should see the link "Drupal Trademark Logo" in the "Content Well"
    And I am on "fr/contenu/application-drupal"
    Then I should see the link "Drupal logo de la marque" in the "Content Well"
