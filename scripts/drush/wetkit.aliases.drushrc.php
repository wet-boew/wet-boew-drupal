...
/**
 * @file
 * Site aliases for a wetkit website
 */

/**
 * Local site alias (http://wetkit.localhost)
 */
$aliases['local'] = array(
  'root' => '/home/username/projects/wetkit',
  'uri'  => 'wetkit.localhost',
  'path-aliases' => array(
    '%dump-dir' => '/tmp',
  ),
);
...
/**
 * Development site alias (http://wetkit.dev.drush)
 */
$aliases['dev'] = array(
  'uri' => 'wetkit.dev.drush',
  'root' => '/var/www/wetkit.dev.drush',
  'remote-user' => 'username',
  'remote-host' => 'wetkit.dev.drush',
  'path-aliases' => array(
    '%dump-dir' => '/tmp',
  ),
...
/**
 * Production site alias (http://wetkit.drush)
 */
$aliases['prod'] = array(
  'parent' => '@wetkit.dev',
  'uri' => 'wetkit.drush',
  'root' => '/var/www/wetkit.drush',
  'remote-user' => 'username-prod',
  'remote-host' => 'wetkit.drush',
);
