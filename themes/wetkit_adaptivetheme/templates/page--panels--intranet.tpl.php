            ...
            <div id="gcwu-gcnb-in">
              ...
              <div id="gcwu-gcnb-fip">
                  ...
                  <div id="gcwu-sig-in">
                    <?php if ($language->language == 'en'): ?>
                      <div id="gcwu-sig-eng" title="Government of Canada">
                        <img src="<?php print (base_path() . libraries_get_path('wet-boew'));?>/dist/theme-gcwu-fegc/images/sig-eng-w.png" width="214" height="20" alt="Government of Canada">
                      </div>
                    <?php endif;?>
                    <?php if ($language->language == 'fr'): ?>
                      <div id="gcwu-sig-fra" title="Gouvernement du Canada">
                        <img src="<?php print (base_path() . libraries_get_path('wet-boew'));?>/dist/theme-gcwu-fegc/images/sig-fra-w.png" width="214" height="20" alt="Gouvernement du Canada">
                      </div>
                    <?php endif;?>
                  </div>
                </div>
                <div id="gcwu-wmms">
                  <div id="gcwu-wmms-in">
                    <?php if ($language->language == 'en'): ?>
                    <div id="gcwu-wmms-fip" title="Symbol of the Government of Canada"><img src="<?php print (base_path() . libraries_get_path('wet-boew'));?>/dist/theme-gcwu-fegc/images/wmms-w.png" width="126" height="30" alt="Symbol of the Government of Canada"></div>
                    <?php endif;?>
                    <?php if ($language->language == 'fr'): ?>
                    <div id="gcwu-wmms-fip" title="Symbole du gouvernement du Canada"><img src="<?php print (base_path() . libraries_get_path('wet-boew'));?>/dist/theme-gcwu-fegc/images/wmms-w.png" width="126" height="30" alt="Symbole du gouvernement du Canada"></div>
                    <?php endif;?>
                  </div>
                </div>
              </div>
